        ...
        <div className="row">
          <div className="col-md-6">
            <KTCodeExample jsCode={jsCode1} beforeCodeTitle="Spinners">
              <span>Spinners can be used to show the loading state in your projects.</span>
            ...
            <KTCodeExample jsCode={jsCode5} beforeCodeTitle="Buttons">
              <span>
                Like the original Bootstrap spinners, these can also be used with buttons. To use
                this component out-of-the-box it is recommended you change the element type to{" "}
          ...
          <div className="col-md-6">
            <KTCodeExample jsCode={jsCode2} beforeCodeTitle="Animations">
              <span>
                Bootstrap offers two animation styles for spinners. The animation style can be
                configured with the <code>animation</code> property. An animation style must always
            ...
            <KTCodeExample jsCode={jsCode4} beforeCodeTitle="Sizing">
              <span>
                In addition to the standard size, a smaller additional preconfigured size is
                available by configuring the <code>size</code> property to <code>sm</code>.
              </span>
              <div className="separator separator-dashed my-7" />
              <>
                <span className="pe-4">
            ...
            <KTCodeExample jsCode={jsCode6} beforeCodeTitle="Accessibility">
              <span>
                To ensure the maximum accessibility for spinner components it is recommended you
                provide a relevant ARIA <code>role</code> property, and include screenreader-only
                readable text representation of the spinner's meaning inside the component using
                Bootstrap's <code>sr-only</code> class.
              </span>
              <div className="separator separator-dashed my-7" />
              <Spinner animation="border" role="status">
                <span className="sr-only">Loading...</span>
