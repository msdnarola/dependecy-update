        ...
        <div className="row">
          <div className="col-md-6">
            ...
            <KTCodeExample jsCode={jsCode3} beforeCodeTitle="Button tags">
              <span>
                ...
                <code>&lt;button&gt;</code> element. However you can render whatever you'd like,
                adding a <code>href</code> prop will automatically render an{" "}
                <code>&lt;a /&gt;</code> element. You can use the <code>as</code> prop to render
                whatever your heart desires. React Bootstrap will take care of the proper ARIA roles
                for you.
              </span>
              <div className="separator separator-dashed my-7" />
            ...
            <KTCodeExample jsCode={jsCode9} beforeCodeTitle="Checkbox / Radio">
              <span>
                Button's can also be used to style <code>checkbox</code> and <code>radio</code> form
          ...
          <div className="col-md-6">
            <KTCodeExample jsCode={jsCode2} beforeCodeTitle="Outline buttons">
              <span>
                For a lighter touch, Buttons also come in <code>outline-*</code> variants with no
                background color.
              </span>
              <div className="separator separator-dashed my-7" />
              <ButtonToolbar>
            ...
            <KTCodeExample jsCode={jsCode4} beforeCodeTitle="Sizes">
              <span>
                Fancy larger or smaller buttons? Add <code>size="lg"</code>, <code>size="sm"</code>{" "}
