      ...
      <div className="row">
        <div className="col-md-6">
          <KTCodeExample jsCode={jsCode1} beforeCodeTitle="Simple links">
            <span>
              The Link component is built on top of the <code>Typography</code> component. You can
              leverage its properties.
            </span>
        ...
        <div className="col-md-6">
          <KTCodeExample jsCode={jsCode2} beforeCodeTitle="Third-party routing library">
            <span>
              One common use case is to perform the navigation on the client only, without doing a
              .html round-trip with the server. The <code>Link</code> component provides a property
              to handle this use case: <code>component</code>.
            </span>
            <div className="separator separator-dashed my-7" />
