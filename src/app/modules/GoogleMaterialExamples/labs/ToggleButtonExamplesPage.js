  ...
  return (
    <>
      <Notice icon="flaticon-warning font-primary">
        <span>Toggle buttons can be used to group related options.</span> For more info please check
        the components's official{" "}
      ...
      <KTCodeExample jsCode={jsCode1} beforeCodeTitle="Toggle Buttons">
        <div className="section">
          ...
          <p className="section-sub">
            The <code>ToggleButtonGroup</code> will control the selected of its child buttons when
            given its own <code>value</code> prop.
          </p>
            ...
            <Grid container spacing={2}>
              <Grid item sm={12} md={6}>
                <div className={classes1.toggleContainer}>
                  <ToggleButtonGroup value={alignment1} exclusive onChange={handleAlignment1}>
                ...
                <Typography>
                  Text justification toggle buttons present options for left, right, center, full,
                  and justified text with only one item available for selection at a time. Selecting
                  one option deselects any other.
                </Typography>
              </Grid>
              <Grid item sm={12} md={6}>
                <div className={classes1.toggleContainer}>
