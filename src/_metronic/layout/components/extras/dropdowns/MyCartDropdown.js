      ...
      <Dropdown.Menu className="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-xl dropdown-menu-anim-up">
        <form>
          <div
            ...
            <span className="btn btn-md btn-icon bg-white-o-15 me-4">
              <i className="flaticon2-shopping-cart-1 text-success"></i>
            </span>
            <h4 className="text-white m-0 flex-grow-1 me-3">My Cart</h4>
          ...
          <PerfectScrollbar
            ...
            <div className="d-flex align-items-center justify-content-between p-8">
              <div className="d-flex flex-column me-2">
                ...
                <div className="d-flex align-items-center mt-2">
                  <span className="font-weight-bold me-1 text-dark-75 font-size-3">$ 350</span>
                  <span className="text-muted me-1">for</span>
                  <span className="font-weight-bold me-2 text-dark-75 font-size-3">5</span>
                  <a href="#" className="btn btn-xs btn-light-success btn-icon me-2">
            ...
            <div className="d-flex align-items-center justify-content-between p-8">
              <div className="d-flex flex-column me-2">
                ...
                <div className="d-flex align-items-center mt-2">
                  <span className="font-weight-bold me-1 text-dark-75 font-size-3">$ 650</span>
                  <span className="text-muted me-1">for</span>
                  <span className="font-weight-bold me-2 text-dark-75 font-size-3">4</span>
                  <a href="#" className="btn btn-xs btn-light-success btn-icon me-2">
                    <i className="ki ki-minus icon-xs"></i>
                  </a>
                  <a href="#" className="btn btn-xs btn-light-success btn-icon">
            ...
            <div className="d-flex align-items-center justify-content-between p-8">
              <div className="d-flex flex-column me-2">
                ...
                <div className="d-flex align-items-center mt-2">
                  <span className="font-weight-bold me-1 text-dark-75 font-size-sm">$ 150</span>
                  <span className="text-muted me-1">for</span>
                  <span className="font-weight-bold me-2 text-dark-75 font-size-sm">3</span>
                  <a href="#" className="btn btn-xs btn-light-success btn-icon me-2">
                    <i className="ki ki-minus icon-xs"></i>
                  </a>
                  <a href="#" className="btn btn-xs btn-light-success btn-icon">
            ...
            <div className="d-flex align-items-center justify-content-between p-8">
              <div className="d-flex flex-column me-2">
                ...
                <div className="d-flex align-items-center mt-2">
                  <span className="font-weight-bold me-1 text-dark-75 font-size-sm">$ 1450</span>
                  <span className="text-muted me-1">for</span>
                  <span className="font-weight-bold me-2 text-dark-75 font-size-sm">7</span>
                  <a href="#" className="btn btn-xs btn-light-success btn-icon me-2">
                    <i className="ki ki-minus icon-xs"></i>
                  </a>
                  <a href="#" className="btn btn-xs btn-light-success btn-icon">
          ...
          <div className="p-8">
            <div className="d-flex align-items-center justify-content-between mb-4">
              <span className="font-weight-bold text-muted font-size-sm me-2">Total</span>
            ...
            <div className="d-flex align-items-center justify-content-between mb-7">
              <span className="font-weight-bold text-muted font-size-sm me-2">Sub total</span>
