      ...
      <div
        ...
        <div className="d-flex align-items-center flex-wrap me-1">
          ...
          {layoutProps.subheaderMobileToggle && (
            <button
              className="burger-icon burger-icon-left me-4 d-inline-block d-lg-none"
          ...
          <div className="d-flex flex-column">
            {/* begin::Title */}
            <h2 className="text-white font-weight-bold my-2 me-5">{subheader.title}</h2>
            {/* end::Title */}
        ...
        <div className="d-flex align-items-center">
          <button
            type="button"
            className="btn btn-transparent-white font-weight-bold  py-3 px-6 me-4">
            Reports
          </button>
          <QuickActions />
        </div>
