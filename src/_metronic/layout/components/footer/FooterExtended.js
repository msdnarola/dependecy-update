          ...
          <div className="row">
            ...
            <div className="col-lg-4 my-lg-0 my-5">
              ...
              <div className="d-flex align-items-center">
                <div className="d-flex flex-column me-18">
                  <a href="#" className="text-white opacity-55 text-hover-primary">
                    General Reports
                  </a>
                  <a href="#" className="py-2 text-white opacity-55 text-hover-primary">
                    Dashboart Widgets
                  </a>
                  <a href="#" className="text-white opacity-50 text-hover-primary">
                    Custom Pages
                  </a>
                </div>
            ...
            <div className="col-lg-4 my-lg-0 my-5">
              ...
              <form className="rounded" style={{ backgroundColor: "rgba(0,0,0,.2);" }}>
                <div className="input-group p-2 align-items-center">
                  ...
                  />
                  <div className="input-group-append p-0 me-1">
                    <button
        ...
        <div className={`${footerContainerClasses} py-8`}>
          <div className="d-flex align-items-center justify-content-between flex-lg-row flex-column">
            ...
            <div className="d-flex align-items-center order-lg-1 order-2">
              ...
              />
              <span className="text-muted font-weight-bold mx-2">{today} ©</span>
              <a
            ...
            <div className="d-flex align-items-center order-lg-2 order-1 mb-lg-0 mb-5">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-white opacity-55 ps-0 text-hover-primary">
                Purchase Lisence
              </a>
              <a
                href="http://keenthemes.com/metronic"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-white opacity-55 pe-0 text-hover-primary">
                Contact
              </a>
            </div>
            {/* end::Nav */}
