    ...
    <div className="d-flex align-items-center py-3">
      {isLoading && (
        <div className="d-flex align-items-center">
          <div className="me-2 text-muted">Loading...</div>
          <div className="spinner spinner-primary me-10"></div>
        </div>
      )}
      <select
        disabled={totalSize === 0}
        className={`form-control form-control-sm font-weight-bold me-4 border-0 bg-light ${totalSize ===
          0 && "disabled"}`}
